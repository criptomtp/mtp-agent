...
STATIC_NICHES = {
    "фулфілмент": [
        "косметика інтернет-магазин", "купити одяг онлайн", "купити взуття онлайн",
        "дитячі іграшки інтернет-магазин", "електроніка купити онлайн",
        "зоотовари інтернет-магазин", "спортивні товари купити",
        "товари для дому онлайн", "ювелірні прикраси купити",
        "дитячий одяг інтернет-магазин", "жіночий одяг купити",
        "чоловічий одяг онлайн", "аксесуари сумки купити",
        "натуральна косметика магазин", "парфумерія інтернет-магазин",
        "біжутерія купити онлайн", "білизна інтернет-магазин",
        "органічна їжа доставка", "чай кава інтернет-магазин",
        "товари для сну купити", "посуд онлайн магазин",
        "декор інтер'єр купити", "садові товари інтернет-магазин",
        "автоаксесуари онлайн", "канцтовари інтернет-магазин",
        "продавці Prom.ua", "магазини Rozetka продавці",
        "e-commerce brand Ukraine", "shopify store Ukraine",
        "інтернет-магазин Україна", "онлайн магазин доставка",
    ],
    "fulfillment": [
        ...
        "pet supplies online Ukraine", "home goods store Ukraine",
    ],
    "юрист": [
...
Визнач хто є потенційними B2B клієнтами цього бізнесу і дай 25 конкретних пошукових запитів для Google.

ВАЖЛИВО: запити мають бути КОНКРЕТНИМИ товарними категоріями, щоб знайти реальні інтернет-магазини.
НЕ пиши абстрактні запити типу "e-commerce бренди" чи "онлайн ритейлери".

Приклад для фулфілменту:
["косметика інтернет-магазин", "купити одяг онлайн", "дитячі іграшки магазин", "взуття купити онлайн", "зоотовари інтернет-магазин", "спортивні товари купити", "електроніка онлайн магазин"]

Дай 25 запитів українською мовою. Кожен запит — конкретна товарна ніша + "купити"/"інтернет-магазин"/"онлайн".
